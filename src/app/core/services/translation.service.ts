...
export class TranslationService {
  ...
  private translations: Translations = {
    en: {
      ...
      'calendar.title': 'MOROCCAN FOOTBALL LEAGUE',
      'calendar.subtitle': 'Moroccan Football Championship',
      'calendar.excelLabel': 'Excel File:',
      'calendar.configLabel': 'Configuration:',
      'calendar.selectFile': 'Select Excel file',
      'calendar.selectConfig': 'Select configuration',
      ...
      'calendar.errorFileConfig': 'Please select Excel file and configuration.',
    ...
    ar: {
      ...
      // Generate Calendar Page
      'calendar.title': 'بطولة كرة القدم المغربية',
      'calendar.subtitle': 'بطولة المغرب لكرة القدم',
      'calendar.excelLabel': 'ملف إكسل:',
      'calendar.configLabel': 'الإعدادات:',
      'calendar.selectFile': 'اختر ملف إكسل',
      'calendar.selectConfig': 'اختر الإعدادات',
      'calendar.generateButton': 'إنشاء الجدول',
      'calendar.loading': 'جاري إنشاء الجدول...',
      'calendar.success': 'تم إنشاء الجدول وتنزيله بنجاح!',
      'calendar.errorFileConfig': 'يرجى اختيار ملف إكسل والإعدادات.',
